...
public class Room2Activity extends FragmentActivity {
	...
	class MyAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int arg0) {
			...
			if(arg0 ==0){
				...
				fragment= new buttons1();
				return fragment;
			}
			else if(arg0 ==1){
				
				fragment= new temperature1();
				return fragment;
			}
			else if(arg0 ==2){
				fragment= new color1();
	...
	//Preference
	    ...
	    public boolean onOptionsItemSelected(MenuItem item)
	    {
	     ...
	     case R.id.menu_jarvis:
	    	 Intent jarvis= new Intent(Room2Activity.this,Jarvis.class);
