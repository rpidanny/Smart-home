...
public class color extends Fragment implements OnTouchListener, OnSeekBarChangeListener, View.OnClickListener{
	...
	public void onPause() {
		...
		private void sendToArduino(int color){
			...
			String URL = Room1Activity.ServerIpAddress+":8080/cgi-bin/setRGB.py?R="+RED+"&G="+GREEN+"&B="+BLUE;
